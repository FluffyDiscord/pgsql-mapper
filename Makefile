srcdir = /home/k/PhpstormProjects/pgsql-mapper
builddir = /home/k/PhpstormProjects/pgsql-mapper
top_srcdir = /home/k/PhpstormProjects/pgsql-mapper
top_builddir = /home/k/PhpstormProjects/pgsql-mapper
EGREP = /bin/grep -E
SED = /bin/sed
AWK = gawk
SHLIB_SUFFIX_NAME = so
SHLIB_DL_SUFFIX_NAME = so
PGSQL_MAPPER_SHARED_LIBADD = -Wl,-rpath,/usr/lib/postgresql17/lib64 -L/usr/lib/postgresql17/lib64 -lpq
shared_objects_pgsql_mapper = pgsql_mapper.lo
PHP_PECL_EXTENSION = pgsql_mapper
PHP_MODULES = $(phplibdir)/pgsql_mapper.la
PHP_ZEND_EX =
...
phpincludedir = /usr/include/php8
CC = cc
CFLAGS = -g -O2
...
EXTRA_LDFLAGS =
EXTRA_LIBS =
INCLUDES = -I/usr/include/php8 -I/usr/include/php8/main -I/usr/include/php8/TSRM -I/usr/include/php8/Zend -I/usr/include/php8/ext -I/usr/include/php8/ext/date/lib -I/usr/include/pgsql
LDFLAGS =
LIBTOOL = $(SHELL) $(top_builddir)/libtool
SHELL = /bin/sh
INSTALL_HEADERS =
BUILD_CC = cc
phplibdir = /home/k/PhpstormProjects/pgsql-mapper/modules
...
-include pgsql_mapper.dep
pgsql_mapper.lo: /home/k/PhpstormProjects/pgsql-mapper/pgsql_mapper.c
	$(LIBTOOL) --tag=CC --mode=compile $(CC) -I. -I/home/k/PhpstormProjects/pgsql-mapper $(COMMON_FLAGS) $(CFLAGS_CLEAN) $(EXTRA_CFLAGS)   -DZEND_COMPILE_DL_EXT=1 -c /home/k/PhpstormProjects/pgsql-mapper/pgsql_mapper.c -o pgsql_mapper.lo  -MMD -MF pgsql_mapper.dep -MT pgsql_mapper.lo
$(phplibdir)/pgsql_mapper.la: ./pgsql_mapper.la
	$(LIBTOOL) --tag=CC --mode=install cp ./pgsql_mapper.la $(phplibdir)

./pgsql_mapper.la: $(shared_objects_pgsql_mapper) $(PGSQL_MAPPER_SHARED_DEPENDENCIES)
	$(LIBTOOL) --tag=CC --mode=link $(CC) -shared $(COMMON_FLAGS) $(CFLAGS_CLEAN) $(EXTRA_CFLAGS) $(LDFLAGS)  -o $@ -export-dynamic -avoid-version -prefer-pic -module -rpath $(phplibdir) $(EXTRA_LDFLAGS) $(shared_objects_pgsql_mapper) $(PGSQL_MAPPER_SHARED_LIBADD)
